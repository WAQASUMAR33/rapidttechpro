          ...
          >
            ...
            >
              ...
              <div className="col-span-3 p-4">
                ...
                <p className="text-xl">{(typeof selectedProject.shortDescription === 'string' ? selectedProject.shortDescription : '') || (typeof selectedProject.description === 'string' ? selectedProject.description : '')}</p>
                <button
