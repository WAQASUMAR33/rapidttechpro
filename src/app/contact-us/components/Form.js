    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch('/api/contact', {
                ...
                body: JSON.stringify({ ...formData, interests: selected }),
            });
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    ...
                    <div className="mt-12 pt-10 border-t border-white/10 flex flex-col gap-3">
                        <a href="tel:+923403051059" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                    ...
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-4 rounded-xl font-black text-white text-base tracking-wide transition-all hover:opacity-90 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
