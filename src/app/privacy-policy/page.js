export const metadata = {
  ...
  description: "Read RapidTechPro's privacy policy to understand how we collect, use, and protect your personal information.",
  alternates: {
    canonical: "https://rapidtechpro.com/privacy-policy",
  },
};
      ...
      <div className=" min-h-screen py-12">
        <div className="container mx-auto  lg:px-8 max-w-7xl py-10">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed text-2xl">
            <p>
              Welcome to RapidTecPro! Your privacy is critically important to us. This privacy policy explains how we collect, use, disclose, and protect your personal information when you visit or make a purchase from www.rapidtecpro.com.
            </p>

            <h2 className="text-2xl font-semibold mt-8">1. Introduction</h2>
            <ol>
                <li>
                “RapidTecPro” is a software development company specializing in delivering high-quality web, app, and software solutions for various clients.
                </li>
                <li>
