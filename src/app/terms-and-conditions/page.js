      ...
      <div className="min-h-screen py-12">
        <div className="container mx-auto lg:px-8 max-w-7xl py-10">
          <h1 className="text-4xl font-extrabold mb-8 text-center text-gray-900">
            Terms and Conditions for RapidTecPro
          </h1>
          <div className="space-y-6 text-gray-700 leading-relaxed text-2xl">
            <p>
              Welcome to RapidTecPro! By using our website and services, you agree to abide by the following terms and conditions. Please read them carefully.
            </p>

            <h2 className="text-2xl font-semibold mt-8">1. Introduction</h2>
            <ol>
              <li>
                These Terms and Conditions govern your use of the RapidTecPro website and services. By accessing or using our services, you agree to comply with these terms.
              </li>
              <li>
                RapidTecPro reserves the right to modify or update these terms at any time, so please review them regularly.
              </li>
            </ol>
